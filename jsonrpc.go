...
type Response struct {
	...
	Error  *struct {   // Error is nil for a successfull request.
		Code    int         // Error code as returned by the server.
		Message string      // Error messase as returned by the server.
		Data    interface{} // Error data object as returned by the server, or nil.
	}
